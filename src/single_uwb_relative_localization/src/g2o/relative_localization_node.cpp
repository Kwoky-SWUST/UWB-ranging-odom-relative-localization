...
void plotEstGlo(int minX=-10, int maxX=20, int minY=-10, int maxY=20)
{
	std::string cmd;
...
double m_dBinningMaxX=20;
double m_dBinningMinY=-10;
double m_dBinningMaxY=20;
// --------------------------------------------------------------------------
