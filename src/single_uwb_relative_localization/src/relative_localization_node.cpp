...
// const double INITIAL2_X = 0;
// const double INITIAL2_Y = 0;
// const double INITIAL2_YAW = 0;
// const double INITIAL3_X = 0;
// const double INITIAL3_Y = 0;
// const double INITIAL3_YAW = 0;
...
void robot1OdomCallback(const nav_msgs::Odometry::ConstPtr &msg)
{
	...
	est_pose_.pose.pose.position.z = 0;
	tf::Quaternion q_yaw;
	q_yaw.setRPY(0, 0, est_pose.yaw);
	est_pose_.pose.pose.orientation.x = q_yaw.x();
	est_pose_.pose.pose.orientation.y = q_yaw.y();
	est_pose_.pose.pose.orientation.z = q_yaw.z();
	est_pose_.pose.pose.orientation.w = q_yaw.w();
	robot1_pub.publish(est_pose_);
#endif
#endif
#ifdef SAVE_G2O_DATA
