...
const int TIME_WINDOW_SIZE = 200;
const int TIME_GRAP = 10;
...
{
	if(fabs(m_v_odom[anchor_name].back().timestamp  - time) < 0.05)
	{
	...
	if(m_flag[anchor_name]==1 && fabs(m_v_odom[anchor_name].back().timestamp  - time) >= 0.05)
	{
