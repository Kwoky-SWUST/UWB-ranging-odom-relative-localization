...
const double GOAL2_X = INITIAL2_X;
const double GOAL2_Y = 0;
const double GOAL2_YAW = 0;
const double GOAL3_X = INITIAL3_X;
const double GOAL3_Y = 0;
const double GOAL3_YAW = 0;

const double GOAL22_X = INITIAL2_X;
const double GOAL22_Y = 0;
const double GOAL22_YAW = 0;
const double GOAL33_X = 2*INITIAL3_X;
const double GOAL33_Y = 0;
const double GOAL33_YAW = 0;

double UNLOCK_ROBOT2_STATE1;
double UNLOCK_ROBOT3_STATE1;
double UNLOCK_ROBOT2_STATE2;
double UNLOCK_ROBOT3_STATE2;
...
{
  UNLOCK_ROBOT2_STATE1 = fabs(INITIAL2_X) + fabs(INITIAL2_Y);
  UNLOCK_ROBOT3_STATE1 = fabs(INITIAL3_X) + fabs(INITIAL3_Y);
  UNLOCK_ROBOT2_STATE2 = fabs(INITIAL2_X) + fabs(INITIAL2_Y);
  UNLOCK_ROBOT3_STATE2 = sqrt(INITIAL3_X*INITIAL3_X + INITIAL3_Y*INITIAL3_Y) + fabs(INITIAL3_X);
